  ...
  return (
    <div className="space-y-6">
      <div className="p-6 bg-gray-50 rounded-2xl border">
        <h2 className="text-2xl font-semibold text-gray-900">Oi, {firstName}! Conte mais sobre seu imóvel</h2>
        ...
        <div className="mt-6 space-y-4">
          ...
          <div>
            ...
            <textarea
              ...
              className="w-full rounded-2xl border border-gray-100 p-4 focus:outline-none focus:ring-2 focus:ring-orange-200 text-lg resize-none"
              placeholder="Descreva seu imóvel, suas características e diferenciais..."
              rows={4}
            />
          </div>
